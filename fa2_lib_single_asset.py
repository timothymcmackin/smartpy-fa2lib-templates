...
"""
This template creates a single asset token contract with the SmartPy FA2 library.
...
4. Compile the contract and run the tests by running `python fa2_lib_single_asset.py`. SmartPy generates output files in the fa2_lib_single_asset folder.
...
def test():
    ...
    scenario = sp.test_scenario("fa2_lib_single_asset", [fa2.t, fa2.main, my_module])
