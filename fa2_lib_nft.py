...
"""
This template creates an NFT contract with the SmartPy FA2 library.
...
4. Compile the contract and run the tests by running `python fa2_lib_nft.py`. SmartPy generates output files in the fa2_lib_nft folder.
...
def test():
    ...
    scenario = sp.test_scenario("fa2_lib_nft", [fa2.t, fa2.main, my_module])
